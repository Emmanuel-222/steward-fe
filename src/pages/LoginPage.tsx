...
function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f6f7fb] px-4 py-8 text-slate-900 sm:px-6 sm:py-10">
      ...
      <div className="relative z-10 flex w-full max-w-5xl flex-col-reverse overflow-hidden rounded-card border border-slate-200 bg-white shadow-[0_40px_120px_rgba(15,23,42,0.12)] lg:grid lg:grid-cols-[0.95fr_1.2fr] animate-stagger-fade">
        <LoginShowcase />
