            ...
            <div className="mb-3 flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-1 shrink-0">
                <button
                  ...
                  className="inline-flex min-h-11 min-w-11 items-center justify-center gap-1.5 rounded-xl p-2.5 text-emerald-600 hover:bg-emerald-50 transition active:scale-90"
                  title="Approve"
                >
                ...
                <button
                  ...
                  disabled={resolveMutation.isPending}
                  className="inline-flex min-h-11 min-w-11 items-center justify-center gap-1.5 rounded-xl p-2.5 text-rose-600 hover:bg-rose-50 transition active:scale-90"
                  title="Reject"
                >
