      ...
      <section className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <div className="inline-flex items-center gap-3 rounded-2xl border border-slate-200/60 bg-white px-4 py-3 shadow-[0_15px_45px_rgba(15,23,42,0.05)]">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#eff4fb] text-brand">
          ...
          {!isFinalized && (
            canFinalize ? (
              <button
                ...
                className="inline-flex items-center justify-center gap-3 rounded-2xl bg-brand px-7 py-4 text-sm font-bold text-white shadow-[0_18px_45px_rgba(15,45,82,0.2)] transition hover:bg-brand-hover disabled:opacity-70"
              >
                {isFinalizing ? (
